...
=== RUN   TestNewEqual
--- PASS: TestNewEqual (0.000181913375854492)
=== RUN   TestErrorMethod
--- PASS: TestErrorMethod (2.81333923339844e-05)
=== RUN   TestIs
--- PASS: TestIs (0.000139951705932617)
=== RUN   TestAs
--- PASS: TestAs (0.0011589527130127)
=== RUN   TestAsValidation
--- PASS: TestAsValidation (9.41753387451172e-05)
=== RUN   TestUnwrap
...
```
=== RUN   TestNewEqual
--- PASS: TestNewEqual (0.000277042388916015625)
=== RUN   TestErrorMethod
--- PASS: TestErrorMethod (3.2901763916015625e-05)
=== RUN   TestIs
--- PASS: TestIs (0.000244140625)
=== RUN   TestAs
--- PASS: TestAs (0.000904083251953125)
=== RUN   TestAsValidation
--- PASS: TestAsValidation (0.000113010406494140625)
=== RUN   TestUnwrap
Unwrap(wrap 2) = null, want 1
```
</p>
